...
# display the message "[name] has now been invited" and add 1 to the count. Then ask if
# they want to invite somebody else. Keep repeating this until they no longer want to invite
